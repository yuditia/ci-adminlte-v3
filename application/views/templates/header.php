...
<head>
  ...
  <title>Sistem Perpus | Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?= base_url() ?>/assets/vendor/adminLTE-3.0.5/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>